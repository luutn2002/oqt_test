...
def binomial(hilbert_size, S=None, N=None, mu=None):
    ...
    statesM2 = [[-0.45717455def fock_dm(hilbert_size, n=None):
    """
    Generates a random fock state.
...
4822e-7,4.569566899500361e-6), \
    ...
    np.complex(0.040721def fock_dm(hilbert_size, n=None):
    """
    Generates a random fock state.
...
def binomial(hilbert_size, S=None, N=None, mu=None):
    ...
    rho = psi*psi.dag()
    return rho.unit(), mu
19358712736,-0.3719310475303641), \
